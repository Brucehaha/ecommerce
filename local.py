"""
Django settings for eflooring project.
...
BASE_URL = 'https://www.eflooring.net'
...
WSGI_APPLICATION = 'eflooring.wsgi.application'
...
from eflooring.aws.conf import *
